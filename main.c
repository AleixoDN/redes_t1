...
int main()
{
    //Teste Lista:
    Lista* li = cria_lista();
    insere_lista_ordenada(li, 10, 02, 2020, "abcde");
    insere_lista_ordenada(li, 10, 02, 2020, "Reuniao Redes");
     insere_lista_ordenada(li, 15, 03, 2022, "Reuniao Redes");
    imprime_lista(li);
...
//OBS: Essa funcao cadastro é um misto da funcao cadastro do cliente e do servidor.
